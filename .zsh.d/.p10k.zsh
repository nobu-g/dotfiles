# Generated by Powerlevel10k configuration wizard on 2021-04-25 at 00:51 JST.
...
() {
  ...
  typeset -g POWERLEVEL9K_INSTANT_PROMPT=quiet  # ignore warning caused by `direnv allow`
