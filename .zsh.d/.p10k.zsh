# Generated by Powerlevel10k configuration wizard on 2019-12-12 at 03:34 JST.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh.
# Wizard options: compatible, lean, 2 lines, disconnected, no frame, compact, concise,
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='%B%n@local'
  # Context format when in SSH without privileges: user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_TEMPLATE='%m'
  # Default context format (no privileges, no SSH): user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='local'
